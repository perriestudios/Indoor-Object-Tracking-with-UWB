...
#define BEACON_1_FIRSTDIST 1.368
#define BEACON_1_SECONDDIST 2.372

#define USE_MEDIAN_FILT true

#define BEACON_1_ADDRESS 0x1A1A
#define BEACON_2_ADDRESS 0x1A2A
#define BEACON_3_ADDRESS 0x1A3A

#define BEACON_1_X 0.00f
#define BEACON_1_Y 0.00f

#define BEACON_2_X 3.0f
#define BEACON_2_Y 0.0f

#define BEACON_3_X 0.0f
#define BEACON_3_Y 3.0f

//First distance from ground truth 2 meters
//Second from ground truth 5 meters.
#define BEACON_1_FIRSTDIST 1.368
#define BEACON_1_SECONDDIST 2.372
float beacon_1_slope = 1.0f/(BEACON_1_SECONDDIST-BEACON_1_FIRSTDIST);
float beacon_1_offset = 2.0f-(1.0f/beacon_1_slope*BEACON_1_SECONDDIST);

//First distance from ground truth 2 meters
//Second from ground truth 5 meters.
#define BEACON_2_FIRSTDIST 1.368
#define BEACON_2_SECONDDIST 2.372
float beacon_2_slope = 1.0f/(BEACON_2_SECONDDIST-BEACON_2_FIRSTDIST);
float beacon_2_offset = 2.0f-(1.0f/beacon_2_slope*BEACON_2_SECONDDIST);

//First distance from ground truth 2 meters
//Second from ground truth 5 meters.
#define BEACON_3_FIRSTDIST 1.368
#define BEACON_3_SECONDDIST 2.372
float beacon_3_slope = 1.0f/(BEACON_3_SECONDDIST-BEACON_3_FIRSTDIST);
float beacon_3_offset = 2.0f-(1.0f/beacon_3_slope*BEACON_3_SECONDDIST);
//
